      ...
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex gap-4">
          <button
            ...
            className="info-bar-grid group relative px-8 py-3 bg-gradient-to-r from-primary/20 via-primary/30 to-primary/20 rounded-full border-2 border-primary text-white font-bold text-sm tracking-wide transition-all duration-500 hover:scale-105 hover:shadow-[0_0_30px_rgba(29,185,84,0.5)] overflow-hidden"
